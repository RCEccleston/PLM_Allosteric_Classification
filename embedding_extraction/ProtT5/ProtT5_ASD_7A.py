...
#training_labels= my_train['label']
#validation_labels= my_valid['label']
#test_labels= my_test['label']

class AlloDataset(Dataset):
  def __init__(self, encodings, labels):
    self.encodings = encodings
    #print(self.encodings[0].shape)
    #print(self.encodings[0])
    self.labels = labels

  def __getitem__(self, idx):
    #print(idx)
    #print("encoding length = ", len(self.encodings))
    #print(self.encodings[0].shape)
...
model_type = 'ProtBert'
experiment = f'ASD_Lig_30I_trunc_{model_type}'
