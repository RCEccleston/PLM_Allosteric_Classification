...
def compute_metrics(p):
    ...
    for thr in thresholds:
        ...
        f1_thr = f1_score(labels, preds_thr)
        f1_scores.append(f1_thr)

    best_idx = np.argmax(f1_scores)
    best_threshold = thresholds[best_idx]

    # Calculate precision, recall, f1, accuracy at best threshold
...
path = '~/PLM_Allosteric_Classification/embedding_classification/esm2_t36_3B_UR50D.ckpt'
