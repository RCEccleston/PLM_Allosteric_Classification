...
max_length = 1024
print(f"Max token length for Ankh Large: {max_length}")
...
training_sequences, training_labels = preprocess_dataset(allo_training_sequences, allo_training_labels, max_length)
validation_sequences, validation_labels = preprocess_dataset(allo_valid_sequences, allo_valid_labels, max_length)
test_sequences, test_labels = preprocess_dataset(allo_test_sequences, allo_test_labels, max_length)
...
path = '~/PLM_Allosteric_Classification/embedding_extraction/Transfer_Learning/Ankh_PDB.ckpt'
