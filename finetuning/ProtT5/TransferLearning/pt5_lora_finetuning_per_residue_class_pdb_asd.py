...
def load_model(filepath, num_labels=2, weight_0=1, weight_1=1, mixed = True):
...
def train_per_residue(
    ...
    # load a new model
    filepath = '/home/lshre1/PredAllo/FineTuning/ProtBert/PT5_secstr_finetuned_ankh_head_pdb.pth'
    model, tokenizer = load_model(filepath=filepath, num_labels=2, weight_0=weight_0, weight_1=weight_1, mixed = True)
    ...
    save_path = os.path.join("lora_binding_sites", f"best_model_pt5_lora_pdb_asd")
